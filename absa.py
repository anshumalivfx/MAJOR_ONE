...
# def best_aspects(text, aspects):
#     similarities = {}

#     # Calculate similarities for each aspect and store in the dictionary
#     for aspect in aspects:
#         similarities[aspect] = float(get_similarity(text, aspect))
...
x = []
sentences = list(df['clean_review'])
...
model = load_model("FlipkartSentimentAnalysis.h5")
